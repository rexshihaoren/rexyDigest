...
If another agent-specific file exists (`AGENT.md`, `CLAUDE.md`, `CURSOR.md`, `.cursorrules`), it must defer to this file instead of duplicating rules.
...
4. Tool-specific adapter files (`AGENT.md`, `CLAUDE.md`, `CURSOR.md`, `.cursorrules`)
